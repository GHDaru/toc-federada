...
JSON escrito em docs/product-site/data.json
  módulos=8 specs=12 adrs=16 RF=359 RI=114 RNF=105 RN=71 INT=61 fontes=176 lacunas=58 ciclos=12
  código: arquivos=181 linhas=49548 testes=133 casos=1571 rotas=144 migrações=9 tabelas=36 portões=28 sabotagens=87 módulos com código=8/8 não atribuídos=9

$ python3 tools/product-site/render.py docs/product-site/data.json --output docs/product-site
  docs/product-site/styles.css (6209 bytes)
  docs/product-site/index.html (99115 bytes)
