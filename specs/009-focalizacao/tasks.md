...
- [ ] T-02 — Consolidar `data-model.md` (extensão do modelo do M1: AnaliseDeFocalizacao,
...
- [ ] T-03 — Declarar `toc.suggest_constraint` (`contracts/acoes-catalogo.md`): nome,
...
- [ ] T-04 — Fixture sintética da análise "Fluxo de matrículas" da Instituição
...
- [ ] T-05 — Domínio da jornada: agregado AnaliseDeFocalizacao, ciclo com os cinco
...
- [ ] T-06 — Recomeço e anti-inércia: fechar ciclo (imutável no domínio), abrir novo em
...
- [ ] T-07 — Migrações Alembic (análise, ciclo, passo, restrição, vínculo, herança) com
...
- [ ] T-08 — Casos de uso + adaptadores REST (análise, restrição, passos, recomeço,
...
- [ ] T-09 — `ux-design.md` das telas da jornada (mapa, painel do passo, julgamento de
...
- [ ] T-10 — UI da jornada: mapa dos cinco passos com estado e pendências, painel do
...
- [ ] T-11 — Borda da sugestão: `toc.suggest_constraint` na FSM do 006 — candidatas a
...
- [ ] T-12 — Vínculos navegáveis contra os módulos reais: criar/vincular ARA do passo
...
- [ ] T-13 — Jornada viva: a análise sintética da Instituição Horizonte de ponta a
...
- [ ] T-14 — Rodar as aptidões e preencher o `qa-report.md`: as 16 linhas da DoD com
