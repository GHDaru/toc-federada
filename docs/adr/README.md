...
| 0014 | [A categoria da linhagem é portada como rótulo opcional, e a transição de status da S&T é livre entre os quatro valores](0014-categoria-portada-e-transicao-de-status-livre-na-snt.md) | Aceita | P3, P4, P2 (INEGOCIÁVEL, alcance estreito declarado no ADR) | 2026-09-06 |
| 0015 | [A ação de catálogo é declarada de uma ferramenta e despacha pela raiz dela; a ARA ganha as ações que a spec 005 já lhe prometia](0015-acao-de-catalogo-pela-raiz-da-ferramenta.md) | Aceita | P2 (INEGOCIÁVEL), P3, P4, P5 | 2026-09-07 |
| 0016 | [A versão do agregado é a metade de domínio da trava, e o portão que a mede tira o denominador do registro de raízes](0016-versao-do-agregado-como-portao-derivado-do-registro.md) | Aceita | P2 (INEGOCIÁVEL, alcance estreito declarado no ADR), P3, P4 | 2026-09-07 |
